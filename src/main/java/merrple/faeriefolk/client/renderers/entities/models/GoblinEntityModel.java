...
@OnlyIn(Dist.CLIENT)
public class GoblinEntityModel<T extends GoblinEntity> extends BipedModel<T> implements IEntityModel, IHasArm {
	...
	public GoblinEntityModel() {
		...
		this.setRotationAngle(torsoUpper, 0.2618F, 0.0F, 0.0F).setRotationPoint(-0.5F, -3.5F, 0.0F);
		...
		this.setRotationAngle(rightArmUpper, -0.0873F, 0.3491F, 0.5236F).setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		this.setRotationAngle(rightArmLower, 0.0F, 0.5236F, 0.7854F).setRotationPoint(4.0F, 0.0F, 0.0F);
		...
		this.setRotationAngle(leftArmUpper, -0.0873F, -0.3491F, -0.5236F).setRotationPoint(0.0F, 0.0F, 1.0F);
		...
		this.setRotationAngle(leftArmLower, 0.0F, -0.5236F, -0.7854F).setRotationPoint(-4.0F, 0.0F, 0.0F);
		...
		this.setRotationAngle(rightLegUpper, 0.3491F, -0.2618F, 0.0F).setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		this.setRotationAngle(rightLegLower, -0.6109F, 0.0F, 0.0F).setRotationPoint(0.0F, 3.0F, 0.0F);
		...
		this.setRotationAngle(rightLegFoot, 0.4363F, 0.0F, 0.0F).setRotationPoint(0.0F, 3.0F, 0.0F);
		...
		this.setRotationAngle(leftLegUpper, 0.3491F, 0.2618F, 0.0F).setRotationPoint(0.0F, 0.0F, 0.0F);
		...
		this.setRotationAngle(leftLegLower, -0.6109F, 0.0F, 0.0F).setRotationPoint(0.0F, 3.0F, 0.0F);
		...
		this.setRotationAngle(leftLegFoot, 0.4363F, 0.0F, 0.0F).setRotationPoint(0.0F, 3.0F, 0.0F);
		this.leftLegLower.addChild(leftLegFoot);
	}
	
	//no head layer at the moment --
	...
	public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
	    ...
	    this.copyRotationAngle(this.rightArm, super.bipedRightArm);
	    this.copyRotationAngle(this.leftArm, super.bipedLeftArm);
	    this.rightLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_225597_3_ * 0.5F;
	    this.leftLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F) * 1.4F * p_225597_3_ * 0.5F;
	}
	...
	protected ModelRenderer getArmForSide(HandSide side, MatrixStack p_225599_2_) {
		...
		p_225599_2_.func_227861_a_(flag ? 0.2D : 0.0D, 0.82D, -0.1D);
